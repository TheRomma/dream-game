...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 111 - ((29 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 111
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 466 - ((47 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 466
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 65 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 145 + 105) / 211)
argglobal
balt renderer.cpp
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 197 - ((4 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 197
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 82 + 105) / 211)
...
exe 'vert 2resize ' . ((&columns * 130 + 105) / 211)
argglobal
balt graphics.cpp
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 198 - ((51 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 198
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 85 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 125 + 105) / 211)
argglobal
balt shader.cpp
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 124 - ((32 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 124
...
badd +1 main.cpp
badd +37 3Dmaths.hpp
badd +34 3Dphysics.hpp
badd +33 renderer.hpp
badd +11 game.hpp
badd +1 3Dmaths.cpp
badd +1 3Dphysics.cpp
badd +1 renderer.cpp
badd +0 game.cpp
badd +25 graphics.hpp
badd +0 graphics.cpp
badd +32 shader.hpp
badd +0 shader.cpp
badd +1 system.hpp
