...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 127 - ((27 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
127
...
wincmd w
argglobal
if bufexists("wrappers.cpp") | buffer wrappers.cpp | else | edit wrappers.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 390 - ((5 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
390
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 63 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 147 + 105) / 211)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 61 - ((21 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
wincmd w
argglobal
if bufexists("resources.cpp") | buffer resources.cpp | else | edit resources.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 137 - ((34 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
137
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((24 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 265 - ((5 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
265
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((41 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
badd +1 entity.hpp
badd +1 entity.cpp
badd +1 components.hpp
badd +1 components.cpp
